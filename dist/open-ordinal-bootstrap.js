 ...
 */
async function getInscriptionMetadata(inscriptionId = getInscriptionIdFromUrl(), baseUrl = _baseUrl) {
...
async function recursiveAvailable(baseUrl = _baseUrl) {
    try {
 ...
 */
async function getInscription(inscriptionId, baseUrl = _baseUrl) {
    try {
 ...
 * @returns {Promise<any>} The Inscrption info
 */
async function getInscriptionContent(inscriptionId, baseUrl = _baseUrl) {
    try {
 ...
 * @returns {Promise<any>} The Inscrption info
 */
async function getInscriptionContentUrl(inscriptionId, baseUrl = _baseUrl) {
...
async function loadInscriptionResources(res) {
    let resources;
    try {
...
async function fetchAndConvertToDataURL(url) {
