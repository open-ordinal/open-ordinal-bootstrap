...
If the `res` property of {@link OOBS.Options Options} are specified the bootrapper will load these. All kinds of inscriptions can be loaded with this option.
